...
/* Supplied by i2c.c */
extern struct device_operations romepsp_i2c_mmio_ops;
/* Supplied by uart.c */
extern struct device_operations romepsp_uart_mmio_ops;
...
struct chip_operations soc_amd_romepsp_ops = {
	CHIP_NAME("AMD RomePSP SOC")
