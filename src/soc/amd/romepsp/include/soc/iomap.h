...
#define  ACPI_CPU_CONTROL	(ROMEPSP_ACPI_IO_BASE + 0x08)     /* 6 bytes */
#define  ACPI_GPE0_BLK		(ROMEPSP_ACPI_IO_BASE + 0x10)     /* 8 bytes */
#define  ACPI_GPE0_STS		(ACPI_GPE0_BLK + 0x00)		  /* 4 bytes */
#define  ACPI_GPE0_EN		(ACPI_GPE0_BLK + 0x04)		  /* 4 bytes */
#define  ACPI_PM_TMR_BLK	(ROMEPSP_ACPI_IO_BASE + 0x18)     /* 4 bytes */
#define NCP_ERR				0xf0
