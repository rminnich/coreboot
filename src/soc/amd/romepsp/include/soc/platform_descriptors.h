...
#ifndef __ROMEPSP_PLATFORM_DESCRIPTORS_H__
#define __ROMEPSP_PLATFORM_DESCRIPTORS_H__
...
void mainboard_get_pcie_ddi_descriptors(
		const romepsp_fsp_pcie_descriptor **pcie_descs, size_t *pcie_num,
		const romepsp_fsp_ddi_descriptor **ddi_descs, size_t *ddi_num);

#endif /* __ROMEPSP_PLATFORM_DESCRIPTORS_H__ */
